...
Uses `twotower_queryonly_back_look.eval.run_eval` (this package's own trimmed-text
...
docstring for why the shared path can't be reused unchanged here.
    ...
    modal volume get dorby-twotower-queryonly-back-look-eval-results queryonly_back_look_001 \\
        ./artifacts/twotower_queryonly_back_look/queryonly_back_look_001_real200
"""
...
RESULTS_VOLUME = "dorby-twotower-queryonly-back-look-eval-results"
...
image = (
    ...
    .add_local_python_source(
        "twotower_queryonly_back_look", "field_pairs_sweep", "query_weighted", "eval_real_full", "twotower", "baselines", "synth_pipeline"
    )
...
def eval_remote(run_id: str, batch_size: int = 8) -> dict:
    ...
    from twotower_queryonly_back_look.eval import run_eval, write_metrics
...
def main(run_id: str = "queryonly_back_look_001", batch_size: int = 8) -> None:
    summary = eval_remote.remote(run_id, batch_size)
    print(f"\n=== {run_id}, all 200 real pairs (queryonly_back_look, both sides) ===")
    ...
    print(
        ...
        f"./artifacts/twotower_queryonly_back_look/{run_id}_real200"
    )
