...
by `tests/test_queryonly_back_look.py::test_preset_matches_top1_ctrl`.
...
`scripts/build_rrf_multineg_triplets_queryonly_back_look.py`, not by anything in
`TrainConfig`.
"""
...
def build_config(
    ...
    **overrides: Any,
    ...
    fields.setdefault("output_dir", Path("artifacts/twotower_queryonly_back_look") / run_id)
