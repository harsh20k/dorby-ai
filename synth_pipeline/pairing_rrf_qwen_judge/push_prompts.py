...
place local prompt text enters the system. Run it before any paid batch::
    ...
    python -m synth_pipeline.pairing_rrf_qwen_judge.push_prompts --dry-run
    python -m synth_pipeline.pairing_rrf_qwen_judge.push_prompts --tag v1
    python -m synth_pipeline.pairing_rrf_qwen_judge.push_prompts --role pair_judge --tag v2
...
from synth_pipeline.pairing_rrf_qwen_judge.prompt_hub import (
    ALL_ROLES,
    DEFAULT_HUB_REPOS,
    LOCAL_FILES,
    PROMPTS_DIR,
