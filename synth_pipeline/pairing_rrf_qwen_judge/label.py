...
ten, that BM25 also surfaced, and that the judge still turned down is the closest
this project has come to the real data's population: something a production
matcher recommended and a human declined. Constructed mismatches are not in the
same class.
