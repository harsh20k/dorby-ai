...
and does twice the forward passes per step of a single-tower run.
  ...
  modal volume get dorby-twotower-ask-offer-posbg-checkpoints ask_offer_001 \\
      ./artifacts/twotower_ask_offer_posbg/ask_offer_001
...
APP_NAME = "dorby-twotower-ask-offer-posbg"
CHECKPOINT_VOLUME = "dorby-twotower-ask-offer-posbg-checkpoints"
...
image = (
    ...
    .add_local_python_source("twotower_ask_offer_posbg", "twotower", "baselines", "eval_real_full", "synth_pipeline")
    ...
    .add_local_dir("artifacts/twotower_ask_offer_posbg", remote_path="/root/rows")
)
...
def train_remote(
    ...
    from twotower_ask_offer_posbg.train import run_training
...
def main(
    ...
    print(
        ...
        f"./artifacts/twotower_ask_offer_posbg/{run_id}"
    )
