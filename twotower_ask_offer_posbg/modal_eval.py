...
from twotower_ask_offer_posbg.modal_train import CHECKPOINT_VOLUME, HF_CACHE_VOLUME, GPU, image
...
app = modal.App("dorby-twotower-ask-offer-posbg-train-eval")
...
def eval_remote(run_id: str, lam: float) -> dict:
    ...
    from twotower_ask_offer_posbg.eval import run_eval
