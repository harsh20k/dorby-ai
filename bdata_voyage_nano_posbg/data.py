    ...
    for c in contacts:
        ...
        if ids:
            ...
            if prev is not None and prev != key:
                # Same Boardy id, different positioning → two catalog people.
...
def expand_resolved_pairs(
    ...
    for row_i, row in enumerate(rows):
        ...
        seeker_text = seeker_look_text(seeker_file, query)
