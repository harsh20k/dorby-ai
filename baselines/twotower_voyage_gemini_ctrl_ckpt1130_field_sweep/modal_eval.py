...
Usage:
  ...
  modal volume get dorby-twotower-voyage-gemini-ctrl-ckpt1130-field-sweep-eval real_all ./artifacts/twotower_voyage_gemini_ctrl_ckpt1130_field_sweep_modal/real_all
"""
...
APP_NAME = "dorby-twotower-voyage-gemini-ctrl-ckpt1130-field-sweep"
RESULTS_VOLUME = "dorby-twotower-voyage-gemini-ctrl-ckpt1130-field-sweep-eval"
HF_CACHE_VOLUME = "dorby-twotower-hf-cache"  # reuse the existing HF model cache
ADAPTER_LOCAL_DIR = "artifacts/twotower_voyage_gemini_ctrl/voyage_gemini_ctrl_001_checkpoint1130/adapter"
...
def sweep_remote(
    ...
    from baselines.twotower_voyage_gemini_ctrl_ckpt1130_field_sweep.sweep import run_sweep
...
def main(
    ...
    """CLI: modal run baselines/twotower_voyage_gemini_ctrl_ckpt1130_field_sweep/modal_eval.py"""
    call = sweep_remote
    ...
    print("=== Modal voyage_gemini_ctrl checkpoint-1130 field/query sweep finished ===")
    ...
    print(
        ...
        f"./artifacts/twotower_voyage_gemini_ctrl_ckpt1130_field_sweep_modal/{result['run_id']}"
    )
