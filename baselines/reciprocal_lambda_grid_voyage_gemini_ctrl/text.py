"""Look-for vs. background text split for the voyage_gemini_ctrl lambda-grid-sweep.

Deliberate duplicate of baselines/reciprocal_lambda_grid/text.py (experiment
isolation rule). Identical field choice: bg_text = positioning + background
