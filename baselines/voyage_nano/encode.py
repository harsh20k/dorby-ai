"""Local Voyage-4-nano encoder via sentence-transformers (query/document prompts)."""
...
class VoyageNanoEncoder:
    ...
    def __init__(
        ...
        self.cache_dir = Path(cache_dir) if cache_dir else Path("artifacts/voyage_nano")
