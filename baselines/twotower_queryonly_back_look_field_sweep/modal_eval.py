"""Modal GPU entrypoint for the 105-combo queryonly_back_look field/query sweep.

One remote call loads voyage-4-nano + the queryonly_back_look LoRA adapter
...
Usage:
  ...
  modal volume get dorby-twotower-queryonly-back-look-field-sweep-eval real_all ./artifacts/twotower_queryonly_back_look_field_sweep_modal/real_all
"""
...
APP_NAME = "dorby-twotower-queryonly-back-look-field-sweep"
RESULTS_VOLUME = "dorby-twotower-queryonly-back-look-field-sweep-eval"
HF_CACHE_VOLUME = "dorby-twotower-hf-cache"  # reuse the existing HF model cache
ADAPTER_LOCAL_DIR = "artifacts/twotower_queryonly_back_look/queryonly_back_look_001/adapter"
...
def sweep_remote(
    ...
    from baselines.twotower_queryonly_back_look_field_sweep.sweep import run_sweep
...
def main(
    ...
    """CLI: modal run baselines/twotower_queryonly_back_look_field_sweep/modal_eval.py"""
    call = sweep_remote
    ...
    print("=== Modal queryonly_back_look field/query sweep finished ===")
    ...
    print(
        ...
        f"./artifacts/twotower_queryonly_back_look_field_sweep_modal/{result['run_id']}"
    )
