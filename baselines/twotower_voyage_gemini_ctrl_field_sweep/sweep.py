...
(``baselines/twotower_voyage_gemini_ctrl_field_sweep/encode.py``), `top1_ctrl`'s
...
from baselines.twotower_voyage_gemini_ctrl_field_sweep.fields import Combo, all_combos, subset_id
from baselines.twotower_voyage_gemini_ctrl_field_sweep.text import candidate_to_text, seeker_to_text
...
def run_sweep(
    *,
    ...
    batch_size: int,
    max_length: int = VOYAGE_GEMINI_CTRL_MAX_SEQ_LENGTH,
