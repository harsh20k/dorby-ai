"""Frozen Voyage-4-nano encoder — copied from baselines/voyage_nano/encode.py.

Do not edit baselines/voyage_nano/. Drift pinned by
tests/test_bdata_voyage_nano_data.py::test_cosine_scores_matches_baselines_voyage_nano.
"""
...
class VoyageNanoEncoder:
    ...
    def __init__(
        ...
        self.cache_dir = Path(cache_dir) if cache_dir else Path("artifacts/bdata_voyage_nano")
