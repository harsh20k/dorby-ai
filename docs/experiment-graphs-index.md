...
| ----------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- | ------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [**`bdata-queryonly-back-look-experiment.html`**](file:///Users/harsh/Artifacts/dorby-ai/docs/html/bdata-queryonly-back-look-experiment.html) | local (`docs/html/`) + [**published**](https://dorby-project-story-411960113601.s3.amazonaws.com/docs/bdata-queryonly-back-look-experiment.html) | **2026-08-18** | **Best 200-pair nano LoRA (`queryonly_back_look_001`) scored on all 18,304 resolved B-data pairs.** Same packing (query → background+lookingFor). Pair AUC **0.5075** (chance; 200-pair was 0.5983); hard-neg **0.4937** (200-pair 0.6564); MRR **0.051**, median rank 96 of 21,168 (200-pair MRR 0.479). Slightly better retrieval than frozen posbg nano (MRR 0.032 / median 184), worse pair AUC (0.5185). Isolated package `bdata_queryonly_back_look/`. Writeup: `docs/bdata-queryonly-back-look-experiment.md`. |
